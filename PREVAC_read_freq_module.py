...
class Application:
    ...
    def Read_Frequency(self):
        ...
        frequency_100 = (256**3)*float(freq[0]) + (256**2)*float(freq[1]) + 256*float(freq[2]) + float(freq[3])
        frequency = frequency_100/100
...
if __name__ == '__main__':
    ...
    '''
# usage example
# import PREVAC_read_freq_module
#        #Define instance from Imported Instrument module and Class
#         self.PREVAC_TM14     = PREVAC_read_freq_module.Application()
